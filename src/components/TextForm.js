    ...
    return (
        <>
            ...
            <h3 className='mt-3' style={{color:"#fff"}}>{props.title1}</h3>
                ...
                <div className='buttons d-flex flex-row flex-wrap mt-4'>
                <button className='btn btn-primary mt-1 rounded mx-3' onClick={uppercase}>Text Uppercase</button>
                <button className='btn btn-success mt-1 rounded mx-3' onClick={lowercase}>Text LowerCase</button>
                <button className='btn btn-warning mt-1 rounded mx-3' onClick={minify}>Minify the CSS</button>
                <button className='btn btn-danger mt-1 rounded mx-3' onClick={clear}>Clear Textfield</button>
                </div>
            </div>
        </>
    )
